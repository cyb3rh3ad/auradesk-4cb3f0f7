...
import { Phone, PhoneOff, Video, Users, Volume2, GripHorizontal } from 'lucide-react';
...
export const IncomingTeamCallDialog = ({ 
  ...
  const getCenteredPosition = () => {
    ...
    const topY = isMobile 
      ...
      : Math.max(20, (window.innerHeight - 420) / 2);
  ...
  useEffect(() => {
    ...
    const handleMove = (e: MouseEvent | TouchEvent) => {
      ...
      const dialogHeight = dragRef.current?.offsetHeight || 420;
  ...
  return (
    <>
      ...
      >
        ...
        <VisuallyHidden.Root>
          <h2>Incoming team call from {callerName}</h2>
          <p>Join or decline the {isVideo ? 'video' : 'voice'} call in {teamName}</p>
        </VisuallyHidden.Root>
        ...
        <div className="p-6 flex flex-col items-center text-center space-y-5">
          ...
          <div className="relative">
            ...
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center relative ring-4 ring-primary/20">
