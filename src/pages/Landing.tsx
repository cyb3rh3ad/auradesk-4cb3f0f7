...
import { Globe, MessageSquare, Video, Users, Brain, FileText, Zap, Shield, Clock, Download, Mail, Check, Star, Headphones, Lock, Sparkles, ArrowRight, Play } from "lucide-react";
        ...
        <div className="container mx-auto max-w-6xl relative">
          ...
          duration: 0.6
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              Like Discord meets Zoom, but better.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <a download className="inline-flex items-center justify-center text-lg font-medium bg-gradient-to-r from-violet-600 via-purple-600 to-blue-600 hover:from-violet-500 hover:via-purple-500 hover:to-blue-500 text-white rounded-xl transition-all duration-300 hover:scale-105 shadow-lg shadow-violet-500/25 hover:shadow-xl hover:shadow-violet-500/30 px-8 py-4 w-full sm:w-auto" href="href=\"https://github.com/cyb3rh3ad/auradesk-4cb3f0f7/releases/download/v1.0.0/AuraDesk.Setup.exe\"">
