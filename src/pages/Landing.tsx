...
const Landing = () => {
  ...
  const features = [
    ...
    { icon: Brain, title: "AI Assistant", description: "Built-in AI chatbot.", gradient: "from-orange-500 to-red-500" },
    {
      icon: Users,
      title: "Team Management",
      description: "Create teams and invite members.",
    ...
    },
    {
      icon: Shield,
      title: "Request Help",
      description: "One-click help requests.",
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden text-center">
        <div className="container mx-auto max-w-6xl space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            {/* DIRECT LINK FROM YOUR GITHUB ASSETS */}
            <a
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-xl px-10 py-7 rounded-xl"
